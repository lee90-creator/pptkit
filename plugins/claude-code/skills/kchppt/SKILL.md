---
name: kchppt
description: Claude Code 터미널 대화에서 요구사항을 확인하고 KCH 양식의 편집 가능한 PPTX를 생성한다. 사용자가 kchppt, KCH PPT, 회사 양식 PPT, 발표자료 생성을 말하면 사용한다.
---

# KCHPPT

모든 상호작용은 현재 Claude Code 터미널 대화 안에서 진행한다. 웹사이트, 브라우저, 로컬 웹 서버,
폼 UI를 열지 않는다.
